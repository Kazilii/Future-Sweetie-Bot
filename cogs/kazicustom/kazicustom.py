		...
		default_global = {
			'barrel': {
				'objects': ['another barrel!* Uh... right, well...',
							...
							"a Bright Star! It looks so pretty!",
							"absolutely nothing. Is this thing broken?",
							"a [REDACTED]. Uh oh [DATA EXPUNGED].",
							"a cowboy plush. It must be high noon!",
							"a Ushanka. Ooh this could be useful in cold weather!",
							"an Antique axe. Hey that's got some good damage!",
							"a bee plush. Awww it's so cute!"],
